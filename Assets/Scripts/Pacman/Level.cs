    ...
    void Update()
    {
       ...
       if(playerGO == null && m_isFinish == false)
        ...
        if (Pacdots.Length == 0 && m_isFinish == false)
        {
            ...
            int numbChem1 = PlayerPrefs.GetInt("CHEM1") + player.m_numbChem1;
            int numbChem2 = PlayerPrefs.GetInt("CHEM2") + player.m_numbChem2;
            int numbChem3 = PlayerPrefs.GetInt("CHEM3") + player.m_numbChem3;

            PlayerPrefs.SetInt("XP", xp);
            PlayerPrefs.SetInt("CERISE", numbCerise);
            PlayerPrefs.SetInt("CHEM1", numbChem1);
            PlayerPrefs.SetInt("CHEM2", numbChem2);
            PlayerPrefs.SetInt("CHEM3", numbChem3);
